  ...
  return (
    <div className="pagamentos-container">
      ...
      <section className="pagamentos-hero">
        <div className="pagamentos-container01">
          <div className="pagamentos-container02">
            <div className="pagamentos-container03">
              <h1>
                <span>Filtros</span>
                <br></br>
              </h1>
            </div>
            <div className="pagamentos-container04">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <span className="pagamentos-text06">
                              Sub-menu Item
                            </span>
                          </div>
                        </li>
                        ...
                        >
                          ...
                          >
                            <span className="pagamentos-text07">
                              Sub-menu Item
                            </span>
                          </div>
                        </li>
                        ...
                        >
                          ...
                          >
                            <span className="pagamentos-text08">
                              Sub-menu Item
                            </span>
                          </div>
                        </li>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span className="pagamentos-text12">
                                Sub-menu Item
                              </span>
                            </div>
                          </li>
                          ...
                          >
                            ...
                            >
                              <span className="pagamentos-text13">
                                Sub-menu Item
                              </span>
                            </div>
                          </li>
                          ...
                          >
                            ...
                            >
                              <span className="pagamentos-text14">
                                Sub-menu Item
                              </span>
                            </div>
                          </li>
    ...
    <tbody>
      ...
      <tr>
        ...
        <header data-thq="thq-navbar" className="pagamentos-navbar">
          ...
          ></div>
          <div data-thq="thq-burger-menu" className="pagamentos-burger-menu">
            <svg viewBox="0 0 1024 1024" className="pagamentos-icon13">
