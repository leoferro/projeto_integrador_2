  ...
  return (
    <div className="planners-container">
      ...
      <section className="planners-hero">
        <div className="planners-container1"></div>
        <header data-thq="thq-navbar" className="planners-navbar">
          ...
          <div data-thq="thq-burger-menu" className="planners-burger-menu">
            <svg viewBox="0 0 1024 1024" className="planners-icon">
          ...
          <div data-thq="thq-mobile-menu" className="planners-mobile-menu">
            ...
            >
              ...
              >
                <span className="planners-text">Features</span>
      ...
      <div className="planners-footer">
        <div className="planners-left1">
          <div className="planners-brand">
            <Link to='/'>
              <img
                alt="image"
                src="/Icons/logo_transparent-300h.png"
                className="planners-image4"
              />
            </Link>
          </div>
          <div className="planners-legal"></div>
        </div>
        <p className="planners-text8">
          Aplicação desenvolvida pelos alunos do eixo computação da Universidade
          Virtual de São Paulo.
        </p>
        <div className="planners-legal1">
          <div className="planners-row">
            <span className="legal-link">Privacy Policy</span>
            <span className="legal-link">Terms of Use</span>
          </div>
          <span className="planners-copyright2">
