...
const TurmasCadastro = (props) => {
  ...
  return (
    <div className="turmas-cadastro-container">
                ...
                <div className="turmas-cadastro-container11">
                  ...
                  <div className="turmas-cadastro-container13">
                    <div className="daysweek">
                      <input type="checkbox" />
                      <span className="turmas-cadastro-text10">
                        Segunda-feira
                      </span>
                    </div>
      ...
      <div className="turmas-cadastro-footer">
        <div className="turmas-cadastro-left1">
          <div className="turmas-cadastro-brand">
            <Link to='/'>
              <img
                alt="image"
                src="/Icons/logo_transparent-300h.png"
                className="turmas-cadastro-image4"
              />
            </Link>
          </div>
          <div className="turmas-cadastro-legal"></div>
        </div>
        <p className="turmas-cadastro-text37">
          Aplicação desenvolvida pelos alunos do eixo computação da Universidade
          Virtual de São Paulo.
        </p>
        <div className="turmas-cadastro-legal1">
          <div className="turmas-cadastro-row">
            <span className="legal-link">Privacy Policy</span>
            <span className="legal-link">Terms of Use</span>
          </div>
          <span className="turmas-cadastro-copyright2">
